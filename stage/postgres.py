...
Engine ленивый и переиспользуется внутри одного процесса — Airflow
форкает воркеров на таск, поэтому держать глобальный pool нет смысла,
но в рамках одного таска connection-ов может быть несколько (executemany
+ TRUNCATE в отдельной транзакции).
"""
