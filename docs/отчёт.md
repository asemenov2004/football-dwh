...
(см. [docs/diagrams/01_c4_context.md](diagrams/01_c4_context.md)):
...
Внутри Football DWH работают 6 контейнеров (см. [docs/diagrams/02_c4_containers.md](diagrams/02_c4_containers.md)):
...
Структура (см. [docs/diagrams/04_er_data_vault.md](diagrams/04_er_data_vault.md)):
...
8 финальных витрин (см. [docs/diagrams/05_er_marts.md](diagrams/05_er_marts.md)):
...
Полная схема потока — [docs/diagrams/03_dfd.md](diagrams/03_dfd.md). Восемь
шагов от ingestion до Superset-чартов, с подписью формата и частоты на
каждой стрелке.
